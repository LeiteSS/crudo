...
class Composer:
  ...
  def compose_node(self, parent, index):
    ...
    if anchor is not None:
      if anchor in self.anchors:
        raise ComposerError("found duplicate anchor %r; first occurence" % anchor, self.anchors[anchor].start_mark, "second occurrence", event.start_mark)
  ...
  def compose_sequence_node(self, anchor):
    ...
    if tag is None or tag == '!':
      tag = self.resolve(SequenceNode, None, start_event.implict)
