...
def test_separator_up():
  ...
  text = KeyInputs.UP + "w" + KeyInputs.SPACE + KeyInputs.ENTER + "\r"
...
def test_select_initial_choice_duplicate():
  message = "Foo message"
  choice = Choice("foo") # there's a error heree
  kwargs = {"choices": ["foo", "choice", "bazz"], "initial_choice": choice} # initial_choice : choice
  text = KeyInputs.DOWN + KeyInputs.SPACE + KeyInputs.ENTER + "\r"
