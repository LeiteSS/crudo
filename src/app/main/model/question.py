...
class Question:
    ...
    predefined question (e.g. text or password).  
    """
    ...
    async def ask_async(
      self, patch_stdout: bool = False, cancel_msg: str = DEFAULT_CANCEL_MESSAGE
    ) -> Any:
    ...
    def ask(
      self, patch_stdout: bool = False, cancel_msg: str = DEFAULT_CANCEL_MESSAGE
        ...
        Args:
            patch_stdout: Ensure that the prompt renders correctly if other
                          threads are printing to stdout.
